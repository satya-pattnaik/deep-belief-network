...
for i in xrange(3):
    ...
    print '================================='
    energy = energyBasedModel.calculateFreeEnergy()
    Energy.append(energy[0,0])
    print 'ENERGY----->',i,'th ITERATION',energy
    print '================================='
...
#y_Axis_Values = xrange(10)
plt.plot(Energy,'bo')

plt.xlabel('ITERATIONS')
plt.ylabel('ENERGY')

plt.title('NEGATIVE ENERGY LOSS IN RESTRICTED BOLTZMANN MACHINE')
plt.show()